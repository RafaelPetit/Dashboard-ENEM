...
from utils.helpers.cache_utils import clear_all_cache, release_memory
    ...
    def cleanup_previous_page(self) -> None:
        ...
        try:
            ...
            if st.session_state.previous_page:
                print(f"[PAGE_MANAGER] Limpeza executada ao sair de: {st.session_state.previous_page}")
...
def safe_page_execution(page_name: str, page_function, *args, **kwargs):
    """
    Executa função de página com tratamento seguro de erros.
